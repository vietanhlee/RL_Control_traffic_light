...
from db.repository import create_repository
from models.metrics.calculator import MetricsCalculator
from models.metrics.collector import DirectionMetrics, MetricsCollector
from models.metrics.measurement_zone import ApproachKey, MeasurementZone
from models.simulation.intersection import Intersection
from models.simulation.road import RoadNetwork
from models.simulation.vehicle import Vehicle, VehicleType
from models.traffic_light.controller import DirectionState, IntersectionState, SimulationState
from models.traffic_light.fixed_time import LightColor
from utils.geometry import calculate_turn_type
...
class SimulationEngine:
    ...
    def choose_turn_type(self, incoming_from: int, via_node: int, outgoing_to: int) -> str:
        ...
        return calculate_turn_type(
            self.network.positions[incoming_from],
            self.network.positions[via_node],
            self.network.positions[outgoing_to],
        )
